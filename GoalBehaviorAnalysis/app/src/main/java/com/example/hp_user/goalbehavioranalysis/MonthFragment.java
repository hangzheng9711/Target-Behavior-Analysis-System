...
public class MonthFragment extends Fragment {
            ...
            switch (msg.what)
            {
                case 1:
                    ...
                    jsonJX(data);
                     ...
                     LineData mLineData = getLineData(length+1, 100,Yvalule);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       View view= inflater.inflate(R.layout.monthzhexian, container, false);
        gongweihao = (EditText)view.findViewById(R.id.workspot_month) ;
        year2 =(EditText)view.findViewById(R.id.year_month) ;
        button = (Button)view.findViewById(R.id.ack_year_month);
        //折线图
        mLineChart1 = (LineChart)view.findViewById(R.id.LineChart_month);
    ...
    private String zhexianchart() throws IOException {
        ...
        String workspot= gongweihao.getText().toString();
        String year=year2.getText().toString();
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                try {
                    ...
                    array1[i][0]=abnormal_time;
                    array1[i][1]=total_time;
                    Yvalule[i]=Float.parseFloat(array1[i][0]);
    ...
    public LineData getLineData(int count, float range,float[]ydata) {
       // count=13;
        ...
        // y轴的数据集合
        LineDataSet dataSet1 = new LineDataSet(yzhi, "每月异常行为时间");
